	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">West Godavari, Palakollu, AndhraPradesh, Pin - 534260</p>
					<p class="lead"><a href="#">+91 992 4042 799</a></p>
					<p><a href="#"> FoodParadise@gmail.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name"> &copy; 2022 <a href="#">Food Paradise Restaurant</a> Developed By :  Kolaparthi Charan
					<a href=""></a><br>
				</p>
					</div>
				</div>
